...
/**
 * This class is realization of (X, Y) vector. Where: X - x coordinate of the vector. Y - y
...
public class Vector2 {
  ...
  /**
   * This constructor will initialize vector (X, Y) from the specified X, Y coordinates.
   * 
  ...
  /**
   * This method will add specified value to X coordinate of the vector. In another words: x +=
   * value.
   * 
   * @param x the X coordinate
   */
  ...
  /**
   * This method will add specified value to Y coordinate of the vector. In another words: y +=
   * value.
   * 
   * @param y the Y coordinate
   */
   ...
   * 
   * @see
   * thothbot.parallax.core.shared.core.Vector#distanceToSquared(thothbot.parallax.core.shared.core.
   * Vector)
   */
   ...
   * 
   * @see
   * thothbot.parallax.core.shared.core.Vector#distanceTo(thothbot.parallax.core.shared.core.Vector)
   */
  ...
  /**
   * Returns true if all of the data members of Tuple2f t1 are equal to the corresponding data
   * members in this Tuple2f.
   * 
